...
class BlockProductsCategory extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'blockproductscategory';
        $this->author = 'Artur Sławuta';
        $this->version = '1.0.0';
        ...
        $this->displayName = $this->trans('Block products in category', [], 'Modules.Blockproductscategory.Admin');
        ...
        $this->templateFile = 'module:blockproductscategory/views/templates/hook/blockproductscategory.tpl';
    }
            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        ...
                        'label' => $this->trans('Category from which to pick products to be displayed. 1 of 3 columns.', [], 'Modules.Featuredproducts.Admin'),
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('blockproductscategory'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('blockproductscategory'));
    }
